      ...
      <main className="aboutMe__body">
        <div className="aboutMe__info">
          ...
          <p className="aboutMe__details">
            Я живу в Воронеже, закончила факультет иностранных языков ВГПУ.
            Работала в службе поддержки 1-го уровня с иностранными клиентами,
            решила посмотреть на процесс с другой стороны, поэтому недавно
            начала кодить.
          </p>
          <ul className="aboutMe__social-list">
            ...
            <li className="aboutMe__social-item">
              <a
                className="aboutMe__social-link"
                href="https://github.com/NataSmit"
                target="blank"
              >
                Github
              </a>
        ...
        <ul className="aboutMe__portfolio-list">
          <li className="aboutMe__portfolio-item">
            <a
              ...
              href="https://github.com/NataSmit/how-to-learn"
              target="blank"
            >
              Статичный сайт
            </a>
          ...
          <li className="aboutMe__portfolio-item">
            <a
              className="aboutMe__portfolio-link"
              href="https://github.com/NataSmit/russian-travel"
              target="blank"
            >
              Адаптивный сайт
            </a>
          ...
          <li className="aboutMe__portfolio-item aboutMe__portfolio-item-no-border">
            <a
              className="aboutMe__portfolio-link"
              href="https://github.com/NataSmit/react-mesto-api-full"
              target="blank"
            >
